...
const HowItWorkCard = () => {
  return (
    <Card className='flex px-10 justify-center'>
      <div className='py-28'>
        <Card className='border-transparent border-r border-r-border rounded-none px-24'>
      ...
      <div className='flex flex-col justify-between py-28 items-center w-1/2 px-24'>
        <FeatureCard>
