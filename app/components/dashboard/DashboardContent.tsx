...
const DashboardContent = () => {
  ...
  const { data: serverInfo, isLoading, error } = useGetServerQuery();
    ...
    <>
      ...
      {session &&
        <Card className='mt-6'>
          <>
            <CardHeader>
              <CardTitle>Content de vous revoir, {session.user.name} 👋</CardTitle>
              <CardDescription>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, voluptates.</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    }
                    {
                      ...
                      <>
                        <Card>
                          ...
                          <CardContent>
                            <div className='flex items-center gap-2'>
                              <div className='text-xl font-bold'>Indisponible</div>
                        ...
                        <Card>
                          ...
                          <CardContent>
                            <div className='text-2xl font-bold'>0.0.0.0</div>
                            <p className='text-xs text-muted-foreground'>+20.1% par rapport au mois dernier</p>
                          </CardContent>
                        </Card>
                        <Card>
